                ...
                <div className="mb-6">
                  ...
                  <div>
                    ...
                    <textarea
                      cols="30"
                      rows="5"
                      className="shadow-lg border-[0.2px] border-gray-200 text-gray-600 px-4 placeholder:text-[#6c6a9a] placeholder:font-[500] w-full lg:w-[480px] py-3 rounded-lg mt-2 outline-none"
                      placeholder="
                        Add detailed of each Room and its size
                      "
                    ></textarea>
                  </div>
                </div>
