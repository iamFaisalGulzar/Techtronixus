  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center ">
        ...
        <div>
          <div className="grid lg:grid-cols-3 gap-24 justify-between">
            <div className="lg:flex hiddentext-left text-[#393486]  font-semibold">
              <svg
            ...
            <div className=" text-center items-center justify-center bg0">
            ...
            <div className="lg:flex hidden text-right items-end justify-end">
      ...
      <hr />
      <div className="relative mx-auto  max-w-5xl my-5">
      ...
      <div className="flex felx-col relative mx-auto  max-w-5xl my-5">
        <div>
          ...
          <div>
            <div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 container mx-auto py-5 items-center justify-center content-center px-14 lg:px-1">
                <div className="w-[438px]  h-auto lg:h-[238px] shadow-lg rounded-xl lg:mb-24 mb-6 cursor-pointer relative">
                  <div>
